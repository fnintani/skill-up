...
function Teacher() {
  return (
    <div className="section" id="teacher">
      <div className="grid sm:grid-cols-2 place-items-center gap-8">
        <div className="pl-5">
          <div className="font-bold text-[1.875rem] sm:text-[1.5rem]">
            Bergabung menjadi <span className="text-blueMain">instruktur</span>{" "}
            <br />
            platform kami
          </div>
          <p className="text-sm leading-7 mt-5">
            ...
            Amet quam rerum nemo rem doloribus dolores excepturi assumenda
            repellat similique natus!
          </p>
      ...
      <div className="text-center font-bold my-8 sm:text-[1.878rem] text-[1.5rem]">
        Frequently<span className="text-blueMain"> Asked Questions</span>
      </div>
